...
| 손세림 | text |
| 송동준 | text |
|    양지혜    | 처음으로 프론트엔드 화면 단을 구성해 보니 보람찬 한편 제 미숙함에 아쉬움이 많았습니다. 또한 axios와 router를 이용해 정보 및 화면을 연결하는 작업이 저에게는 꽤 어렵게 다가왔습니다. 팀원들의 도움이 없었더라면 결코 기간 내에 작업을 완료하지 못했을 겁니다. 프로젝트 마감 기한은 다가오는데 점점 추가할 페이지나 기능들이 눈에 띄어 계속 수정하게 되었습니다. 그럼에도 친절하게 계속 업데이트해 주신 취합자에게 감사함을 전하고 싶습니다. 팀원들이 다양한 기능들을 만들고 백엔드에서 프론트엔드로 정보를 연결하였는데 옆에서 지켜보면서 많은 점을 배웠습니다. 조금씩 개발자로서 성장하는 제 모습을 상상하며 다음 프로젝트에는 좀 더 성숙한 태도로 임하겠습니다. |
| 정태원 | text |
